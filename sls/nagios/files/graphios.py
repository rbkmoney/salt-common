...
class GraphiosMetric(object):
    def __init__(self):
        ...
        self.HOSTDISPLAYNAME = ''           # Icinga Custom var for Display Hostnames
        ...
        self.HOSSTATE = ''             # current state afa nagios is concerned
        ...
        self.CUSTOMER = ''              # icingga custom var to determine the customer
        ...
        if mobj:
            ...
            for metric in mobj.PERFDATA.split():
                try:
                    ...
                    if (len(values) >= 1+1 and values[1] != ""):
                       nobj.WARN = values[1]
                    else:
                       nobj.WARN = ""

                    if (len(values) >= 2+1 and values[2] != ""):
                       nobj.CRIT = values[2]
                    else:
                       nobj.CRIT = ""

                    if (len(values) >= 3+1 and values[3] != ""):
                       nobj.MIN = values[3]
                    else:
                       nobj.MIN = ""

                    if (len(values) >= 4+1 and values[4] != ""):
                       nobj.MAX = values[4]
                    else:
                       nobj.MAX = ""
